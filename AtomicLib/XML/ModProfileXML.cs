...
public class ModProfileXML
{
    ...
    /// <summary>Creates a <see cref="ModProfileXML"/> with a default set of attributes.</summary>
    ...
    /// <summary>
    /// Creates a <see cref="ModProfileXML"/> with a custom set of attributes.
    /// </summary>
    ...
    public ModProfileXML(string operatingSystem, int xmlVersion, string version, string name, string author,
